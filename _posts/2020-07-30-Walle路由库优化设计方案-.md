...
<div style="text-align: center;"><img src="../../../../img/post-flutter-loadmore-1.gif" width="60%" style="display: inline-block; border: 2px solid #000000; margin: 0; padding: 0;"/></div>
...
5. 高阶组件定义：输入是一个组件，产出是一个功能更高阶的组件。
