...
#### 富文本原理
SpannableString集成了SpannableStringInternal，它将大部分逻辑转移到了父类，setSpan()接口的实现逻辑主要也是父类完成的。
```java
...
```
<div style="text-align: center;"><img src="../../../../img/post-textview-5.png" width="80%" style="display: inline-block; border: 2px solid #000000; margin: 0; padding: 0;"/></div>
