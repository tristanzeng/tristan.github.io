...
```js
abstract class HomeStatelessWidget<T> extends StatelessWidget {
...
```
```js
abstract class HomeStatefulWidget<T> extends StatefulWidget {

  HomeStatefulWidget(this.context, this.name, this.value);
