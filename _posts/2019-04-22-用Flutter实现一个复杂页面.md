...
> 3. Flutter的动画设计api很丰富，能充分满足各种UI动效，让页面开发更容易。
> 4. Flutter表达性更强，又加以跨平台的解决方案，大大提升了开发效率，为应用开发起到了开源节流的作用。
> 5. Flutter作为新秀，在Java老大哥已经烂熟于MVP模式设计后，Flutter在此方面还需要积累；也可能Flutter本身并不需要这样的积累，它等待的是比Java中更好的开发模式。
