...
SliverAppBar(
  leading: null,
  // 如果没有leading，且automaticallyImplyLeading为true，就会默认返回箭头
  // 如果没有leading，且automaticallyImplyLeading为false，空间留给title
  // 如果有leading，这个参数就无效了
  ...
  // 只跟floating相对应，如果为true，floating必须为true，也就是向下滑动一点儿，
  // 整个大背景就会动画显示全部，往上滑动整个导航栏的内容就会消失
  snap: false, 
