...
<div style="text-align: center;"><img src="../../../../img/post-flutter-loadmore-1.gif" width="80%" style="display: inline-block; border: 2px solid #000000; margin: 0; padding: 0;"/></div>
...
高阶组件已经为开发者做好了前两步的工作，并将这两步逻辑完全封装了起来，与原生组件在层级上完全隔离，不依赖具体组件的实现，充分做到了可复用；同时提供了最简洁的接口使用，易读性和易用性都很强。
